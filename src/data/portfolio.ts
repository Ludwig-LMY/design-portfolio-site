...
export const portfolioData = {
  ...
  categories: [
    ...
    },
    {
      ...
      note: "游戏部分主要呈现机制组织、反馈判断与整体体验编排能力，用以集中说明其在游戏设计方向上的方法与判断。",
      tags: ["玩法循环", "关卡节奏", "战斗反馈"],
    },
    {
      id: "award-films",
  ...
  projects: [
    {
      ...
      detailSections: [
        ...
        {
          heading: "解决方案",
          body: "项目采用“主线浏览 + 章节切换 + 展项聚焦”的三层结构，先建立整体认知，再提供章节式导览，最后进入具体展项内容，让空间路径与信息结构保持一致。",
        },
        {
          heading: "设计结果",
    ...
    },
    {
      ...
      intro:
        "该项目可被视作一次“如何让训练逻辑被设计成可理解体验”的实践，而不是单纯的技术演示。",
      challenge:
    ...
    },
    {
      ...
      intro:
        "这是一个更能直接体现其游戏设计能力的项目。它不只是一个可运行程序，而是一套围绕移动、射击、爆炸反馈、成长与关卡推进组织起来的完整体验。",
      challenge:
        "游戏项目的核心难点不是把功能堆出来，而是让玩法目标、战斗节奏、反馈层级和关卡推进之间形成稳定循环，让玩家愿意持续投入。",
      detailSections: [
        {
          heading: "项目背景",
          body: "BattleTank 是用于集中验证其游戏设计判断的一次完整实践。相比偏展示型的作品，它更强调玩家行为、实时反馈和目标推进之间的动态关系。",
        },
        {
          heading: "玩法目标",
          body: "项目希望玩家在最短时间内建立明确目标感：看得懂敌我关系、理解射击结果，并在推进中持续感到节奏变化，而不是陷入重复操作。",
        },
        {
          heading: "核心循环",
        ...
        {
          heading: "项目反思",
          body: "这个项目进一步说明，游戏设计最考验的不是单点创意，而是能否把目标、规则、反馈和节奏组织成一个稳定且可持续的体验系统。",
        },
      ],
      keyScreens: [
  ...
  about: {
    title: "其研究与设计工作关注界面背后的秩序、情绪与决策。",
    body:
      "其核心兴趣长期集中在虚拟现实、数字媒体、游戏设计与交互体验研究。好的作品不只需要具备运行与展示能力，也需要在机制、空间、界面和内容之间建立清晰关系，让用户愿意理解、愿意探索并愿意继续停留。",
    cards: [
      {
        title: "清晰的信息结构",
        description:
          "无论是虚拟展馆、VR 教学还是游戏界面，都会先梳理主次关系与认知顺序，再决定形式如何出现。",
      },
      {
        title: "有节奏的交互体验",
        description:
          "重视反馈层级、目标感和推进节奏，强调让用户始终知道自己在做什么，以及为什么愿意继续。",
      },
      {
        title: "可落地的系统化设计",
        description:
          "倾向于把审美、研究与实现放在同一个框架里理解，让表达不是孤立的美术结果，而是可以被执行和复用的方法。",
      },
    ] satisfies AboutCard[],
  },
  skillGroups: [
  ...
  publications: [
    ...
    },
    {
      ...
      date: "2026.03",
      excerpt: "更关注用户如何在空间中建立认知、如何感到安心，以及怎样的设计会让他们愿意继续停留。",
    },
