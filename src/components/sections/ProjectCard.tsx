    ...
    >
      <div className="relative z-10 flex h-full flex-col">
        ...
        <div className="relative mt-6 overflow-hidden rounded-[24px] border border-line bg-[rgba(81,115,63,0.06)]">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(81,115,63,0.14),transparent_58%)]" />
          <ProjectMedia
            project={project}
            mode="card"
        ...
        <div className="mt-6 space-y-4">
          <div className="space-y-3">
            ...
            <h3 className="headline-md max-w-[12ch] transition-transform duration-200 group-hover:-translate-y-0.5">
              {project.name}
            </h3>
          </div>
